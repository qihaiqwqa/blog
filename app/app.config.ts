...
export default defineAppConfig({
	...
	footer: {
		...
		iconNav: [
			...
			{ icon: 'ri:qq-line', text: '个人：2756951158', url: '' },
			{ icon: 'tabler:brand-github', text: 'GitHub: qihaiqwqa', url: 'https://github.com/qihaiqwqa' },
		...
		nav: [
			...
			},
			{
				title: '社交',
				items: [
					{ icon: 'tabler:brand-github', text: 'qihaiqwqa', url: 'https://github.com/qihaiqwqa' },
					{ icon: 'ri:qq-line', text: '个人：2756951158', url: '' },
			...
			},
			{
				...
				items: [
					...
					{ icon: 'tabler:certificate', text: '还没有', url: '' },
				],
			},
		] satisfies Nav,
	},
	...
	/** 左侧栏顶部 Logo */
	header: {
		logo: 'https://qihaiqwq-1317599563.cos.ap-chengdu.myqcloud.com/138101128_p0.png',
		/** 展示标题文本，否则展示纯 Logo */
		showTitle: true,
